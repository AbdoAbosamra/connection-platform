  ...
  routes: [
    ...
    // ── Employer ─────────────────────────────────────────────────
    {
      ...
      children: [
        ...
        { path: 'interviews',             name: 'employer.interviews',    component: () => import('@/pages/employer/Interviews.vue') },
        { path: 'messages',               name: 'employer.messages',      component: () => import('@/pages/shared/Messages.vue') },
        { path: 'analytics',              name: 'employer.analytics',     component: () => import('@/pages/employer/Analytics.vue') },
        { path: 'billing',                name: 'employer.billing',       component: () => import('@/pages/employer/Billing.vue') },
        { path: 'settings',               name: 'employer.settings',      component: () => import('@/pages/employer/Settings.vue') },
        { path: 'compliance',             name: 'employer.compliance',    component: () => import('@/pages/employer/Compliance.vue') },
